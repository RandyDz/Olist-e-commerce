...
all_df=pd.read_csv('all_df (1).csv')
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/RandyDz/olist-e-commerce/e0ab6edebffa841411c6cacf36f406c732ed0656/St%C3%BAdio__1_-removebg-preview.png")
